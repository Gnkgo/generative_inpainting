...
if __name__ == "__main__":
    ...
    dir_item_training = args.folder_path + "/" + dirs[0]
    print(dir_item_training)

    training_folder = os.listdir(dir_item_training)
    for training_item in training_folder:
        training_item = dir_item_training  + training_item
        training_file_names.append(training_item)

    dir_item_validation = args.folder_path + "/" + dirs[1]

    validation_folder = os.listdir(dir_item_validation)
    for validation_item in validation_folder:
        validation_item = dir_item_validation + validation_item
